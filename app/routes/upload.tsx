...
const Upload = () => {
  ...
  const handleAnalyze = async ({
    ...
    setDebugInfo(`File: ${file.name}, Size: ${file.size}, Type: ${file.type}`);
    ...
    // Log warning if using fallback image
    if (imageFile.error) {
      console.warn(
        "Using fallback image due to PDF conversion issues:",
        imageFile.error
      );
      setStatusText("PDF preview unavailable, but continuing with analysis...");
    }
